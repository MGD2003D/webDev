# Generated by Django 5.1.3 on 2024-12-01 23:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cars', models.ManyToManyField(through='app.CarOwner', to='app.car')),
        ...
        migrations.AddField(
            model_name='car',
            name='owners',
            field=models.ManyToManyField(through='app.CarOwner', to='app.owner'),
        ),
    ]
